...
class ConfigHistory:
    ...
    def add(self, key_path: str, old_value: Any, new_value: Any, source: str) -> None:
        """
        添加历史记录
...
class ConfigManager:
    ...
    def validate(self, key_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"valid": False, "value": value, "error": str(e)}
    ...
    def remove_observer(self, observer: Callable[[str, Any, Any], None]) -> bool:
        """
        移除观察者
    ...
    def _collect_keys(
        self, config: Dict[str, Any], prefix: str, keys: List[str]
    ) -> None:
        """
        递归收集配置键
